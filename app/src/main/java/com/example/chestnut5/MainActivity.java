...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        Toolbar toolbarnavi = findViewById(R.id.toolBar);

        NavigationView navigationView = findViewById(R.id.navigation_view);
//        navigationView.setNavigationItemSelectedListener(this);


        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(this, drawerLayout, toolbarnavi,
        ...
        final Toolbar toolbar = findViewById(R.id.toolbarConnect);

        TabLayout tabLayout = findViewById(R.id.tabConnect);
        final ProgressBar progressBar = findViewById(R.id.progressBar);
        progressBar.setVisibility(View.GONE);


        //State Initialization
        State1 = findViewById(R.id.textViewInfo);
        State2 = findViewById(R.id.textViewInfo2);
        State3 = findViewById(R.id.textViewInfo3);
        State4 = findViewById(R.id.textViewInfo4);
        State5 = findViewById(R.id.textViewInfo5);
        State6 = findViewById(R.id.textViewInfo6);
        State7 = findViewById(R.id.textViewInfo7);

        //Switch Initialization
        theSwitch1 = findViewById(R.id.buttonToggle);
        theSwitch2 = findViewById(R.id.buttonToggle2);
        theSwitch3 = findViewById(R.id.buttonToggle3);
        theSwitch4 = findViewById(R.id.buttonToggle4);
        theSwitch5 = findViewById(R.id.buttonToggle5);
        theSwitch6 = findViewById(R.id.buttonToggle6);
        theSwitch7 = findViewById(R.id.buttonToggle7);
        ...
        controllingRelativeL = findViewById(R.id.controllingRelativeL);


        //Control Title Initialization
        controlTitle1 = findViewById(R.id.switch1);
        controlTitle2 = findViewById(R.id.switch2);
        controlTitle3 = findViewById(R.id.switch3);
        controlTitle4 = findViewById(R.id.switch4);
        controlTitle5 = findViewById(R.id.switch5);
        controlTitle6 = findViewById(R.id.switch6);
        controlTitle7 = findViewById(R.id.switch7);
        ...
        final RelativeLayout switches = findViewById(R.id.controllingRelativeL);
        ...
        Overall = findViewById(R.id.overallLinearLayout);
        final LinearLayout noDevice = findViewById(R.id.noDeviceLayout);
                    ...
                    case MESSAGE_READ:
                        ...
                        switch (arduinoMsg.toLowerCase()) {
                            ...
                            case "led3 is turned on":
                                ...
                                img_3.setBackground(getDrawable(R.drawable.switch_drawable_on));
                                RLSwitch3.setBackground(getDrawable(R.drawable.switch_gradient_on));
                            ...
                            case "led3 is turned off":
                                ...
                                RLSwitch3.setBackground(getDrawable(R.drawable.switch_gradient));
